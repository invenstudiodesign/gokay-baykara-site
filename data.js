/* Op. Dr. Gökay Baykara — içerik dosyası
   Bu dosya admin panelindeki "Yayınla" ile üretildi. 07.06.2026 15:58:53
...
window.DATA = {
  "doctor": {
    ...
    "credentials": [
      ...
      [
        "2015–2020",
        "Plastik, Rekonstrüktif ve Estetik Cerrahi İhtisası"
      ],
      [
        "Bugün",
        "Ankara'da özel muayenehane"
      ]
    ]
  },
  "stats": [
  ...
  "services": [
    {
      ...
      "points": [
        "Kişiye özel yüz analizi",
        "Doğal ve dengeli profil",
        "Fonksiyonel (nefes) iyileştirme",
    ...
    },
    {
      ...
      "points": [
        "İmplant veya yağ ile",
        "Bedenle orantılı planlama",
        "Doğal his ve görünüm",
        "Detaylı ölçüm"
      ]
    },
    {
      ...
      "points": [
        "Dik ve toparlanmış hat",
        "Gerekirse hacim ekleme",
        "İz planlaması",
        "Kişiye özel"
      ]
    },
    ...
    },
    {
      "slug": "mikrocerrahi",
      "cat": "rekonstruktif",
      "title": "El Cerrahisi & Mikrocerrahi",
      "sub": "Rekonstrüksiyon",
  ...
  "blog": [
    {
      "slug": "kepce-kulak-operasyonu",
      "title": "Kepçe Kulak Operasyonu",
      "date": "5 Aralık 2022",
      "cat": "Yüz Estetiği",
    ...
    {
      "slug": "rinoplasti-zamanla-iyilesir",
      "title": "Rinoplasti Sonrası Burnunuz Neden Zaman Geçtikçe Daha İyi Görünür?",
      "date": "9 Ekim 2022",
      "cat": "Burun Estetiği",
    ...
    {
      "slug": "karin-germe-liposuction-fark",
      "title": "Karın Germe ve Liposuction Arasındaki Farklar",
  ...
  "testimonials": [
    {
      "text": "Süreç boyunca her aşamayı sabırla anlattı. Sonuç tam istediğim gibi doğal oldu.",
      "who": "Rinoplasti hastası"
    },
    {
      "text": "Kendimi güvende hissettim. İlgisi ve şeffaflığı için minnettarım.",
      "who": "Meme estetiği hastası"
    },
    {
      "text": "Doğal bir sonuç istiyordum ve tam olarak bunu aldım. Teşekkürler.",
      "who": "Yüz germe hastası"
    }
  ],
  "faq": [
    [
      "Randevu nasıl alabilirim?",
      "İletişim formunu doldurarak, telefonla ya da WhatsApp üzerinden ulaşarak randevu oluşturabilirsiniz. İlk görüşmede beklentilerinizi birlikte değerlendiriyoruz."
    ],
    [
      "İlk görüşmede neler oluyor?",
      "İlk görüşmede tıbbi geçmişiniz değerlendirilir, beklentileriniz dinlenir ve size uygun yaklaşım şeffaf biçimde anlatılır. Karar için sizi yönlendirmeden bilgilendirmeyi önceliklendiriyoruz."
    ],
    [
      "İyileşme süreci ne kadar?",
      "İyileşme süreci işleme göre değişir. Her hasta için ayrıntılı bir bakım ve takip planı paylaşılır."
    ],
    [
      "Operasyon nerede yapılıyor?",
      "Operasyonlar Ankara'da tam donanımlı, akredite hastane ortamlarında gerçekleştirilir."
    ]
  ],
  "gallery": [],
  "hero": {
  ...
  "links": {
    ...
    "instagram": "https://www.instagram.com/drgokaybaykara/",
  ...
  "theme": {
    ...
    "sans": "Jost",
    "logoText": "Gökay Baykara",
    "logoSub": "Op. Dr. — Estetik Cerrahi",
    "logoImg": ""
  },
  "sections": [
    {
